...
const tmpVisitor = new Visitor(1, 'Porter', "Dalton", "5 backend Drive", "Heber", "UT", "84032", "7049048450", "potts@mail.com");
...
function validateForm() {
    ...
    //let ischeck = validateCheckboxGroup(checkboxElements, "find-page", "you must select at least one!");
    /*
    if (!ischeck) {
        foundInvalid = true;
    }
